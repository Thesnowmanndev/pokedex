...
const description =
  "A responsive web app containing images and details regarding Pokemon found in the Galar Region";

export default function galar({ pokemon }) {
  return (
    <Layout title="Galar Pokedex" description={description}>
          ...
          <div className="flex items-end justify-between mb-12 bg-white border-b-2 rounded-t-lg header">
            <div className="px-5 pt-10 title">
              ...
              <p className="pt-5 mb-5 text-xl font-light text-gray-500">
                ...
                for the Sword and Shield games on the Nintendo Switch.
              </p>
            </div>
