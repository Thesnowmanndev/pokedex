...
const description =
  "A responsive web app containing images and details regarding Pokemon found in the Sinnoh Region";

export default function sinnoh({ pokemon }) {
  return (
    <Layout title="Sinnoh Pokedex" description={description}>
          ...
          <div className="flex items-end justify-between mb-12 bg-white border-b-2 rounded-t-lg header">
            <div className="px-5 pt-10 title">
              <p className="text-4xl text-gray-600 primary-font">
                Sinnoh Region Pokemon
              </p>
              <p className="pt-5 mb-5 text-xl font-light text-gray-500">
                The Pokemon listed below are the Pokemon originally developed
                for the Diamond, Pearl, and Platinum games on the Nintendo DS
                and the Brilliant Diamond and Shining Pearl games on the
                Nintendo Switch.
              </p>
            </div>
