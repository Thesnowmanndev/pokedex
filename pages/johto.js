...
const description =
  "A responsive web app containing images and details regarding Pokemon found in the Johto Region";

export default function johto({ pokemon }) {
  return (
    <Layout title="Johto Pokedex" description={description}>
...
export async function getStaticProps() {
  try {
    ...
    const pokemon = results.map((result, index) => {
      const paddedIndex = ("00" + (index + 152)).slice(-3);
