...
const description =
  "A responsive web app containing images and details regarding Pokemon found in the Kalos Region";

export default function kalos({ pokemon }) {
  return (
    <Layout title="Kalos Pokedex" description={description}>
          ...
          <div className="flex items-end justify-between mb-12 bg-white border-b-2 rounded-t-lg header">
            <div className="px-5 pt-10 title">
              ...
              <p className="pt-5 mb-5 text-xl font-light text-gray-500">
                ...
                for the X and Y games on the Nintendo 3DS.
              </p>
            </div>
